...
from data import OrderData, AnswerAPI
import allure
...
class TestOrderCreate:
    ...
    def test_create_order_without_ingredients(self):
        ...
        user.delite_reqest_delite_user(access_token_user['accessToken'])
        assert status_code == 400 and str(response_context.get("message")) == AnswerAPI.ANSWER_NO_INGREDIENT
...
class TestGetOrder:
    ...
    def test_get_user_orders_without_login(self):
        ...
        user.delite_reqest_delite_user(access_token_user['accessToken'])
        assert status_code == 401 and str(response_context.get("message")) == AnswerAPI.ANSWER_NEED_LOGIN
